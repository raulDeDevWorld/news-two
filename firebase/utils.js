...
function onAuth(setUserProfile, setUserDate, setUserMonthAndYear, setUserDayMonthYear) {
...
// function getData(rute, setData, monthAndYear) {

//       get(query(ref(db, `${rute}/Posts`), limitToLast(5)))
//         .then((snapshot) => {
//           if (snapshot.exists()) {
//             let snap = snapshot.val()
//             let allData = {
