...
function TemplateSix({ color, topic, banner}) {
    ...
    return (
        <section className={styles.section} id={topic} style={{backgroundColor: color}}>
            ...
            {userDB[topic] && userDB[topic]["BannerTop"] && banner !== 'none' && <Banner ruta={topic} carpeta="BannerTop" click={handlerClickEnlace}></Banner>}
            ...
            {userDB[topic] && userDB[topic]["BannerBottom"] && banner !== 'none' &&  <Banner ruta={topic} carpeta="BannerBottom" click={handlerClickEnlace} ></Banner>}
